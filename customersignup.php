...
if (isset($_POST['submit'])) {
    ...
    $imgname = $_FILES['cusimage']['name'];
    $imgtmp = $_FILES['cusimage']['tmp_name'];
    move_uploaded_file($imgtmp, "img/" . $imgname);

    $query = "INSERT INTO customer (c_name , c_email , c_password , c_contact , c_address ,  c_img) VALUES('$name' , '$email' , '$pass' ,'$contact', ' $address','$imgname')";
            ...
            <div class="col-left">
                <div class="login-form">
                    ...
                    <form method="POST" enctype='multipart/form-data'>
                        ...
                        <p>
                            <input type="email" name="cusemail" placeholder="Email" required>
                        </p>
                        <p>
                            <input type="password" name="cuspass" placeholder="Password" required>
                        </p>
                        <p>
                            <input type="text" name="cuscontact" placeholder="Contact" required>
                        </p>
                        <p>
                            <input type="text" name="cusaddress" placeholder="Address" required>
                        </p>
                        <label class="filebutton" style="text-align:center;">
                            <span class="btn">Select Image
                                <input class="form-control image" type="file" name="cusimage" required>
                            </span>
                        </label>
                        <p>
