    ...
    <div class="container-fluid">
      ...
      <div class="container-fluid d-flex">
        ...
        if (isset($_SESSION['userid'])) {
          ...
          <a href='../customersignup.php'
            class='btn btn-customer m-1 btn-sm border-0 text-white rounded-0 ms-3 d-sm-none'>Customer</a>

          <a href="#" class="ms-3 d-sm-none" data-bs-toggle="dropdown">
            <img class="rounded-circle" src="<?php echo "images/" . $rows['u_img'] ?>" width="35" height="35">
          </a>
          ...
          echo " <a href='../customersignup.php' class='btn btn-customer m-1 btn-sm border-0 text-white rounded-0 ms-2 d-sm-none'>Customer</a>
                 <a href='dealersignup.php' class='btn btn-dealer m-1 btn-sm border-0 text-white rounded-0 ms-2 d-sm-none'>Dealer</a>";
        }
      ...
      <ul class="dd2 dropdown-menu dropdown-menu-end rounded-0">
        ...
        <li><a class="dropdown-item orders p-2" href="orders.php"><i class="fa fa-shopping-basket ms-2 me-3"></i>
            Orders</a></li>
        <li><a class="dropdown-item setting p-2" href="dealerprofileedit.php?id=<?php echo $rows['u_id'] ?>"><i
              class="fas fa-cog ms-2 me-3"></i> Setting</a></li>
        <li><a class="dropdown-item logout p-2" href="dealerlogout.php"><i class="fas fa-power-off ms-2 me-3"></i>
            Logout</a></li>
      ...
      <ul class="navbar-nav ms-auto">
        ...
        if (isset($_SESSION['userid'])) {
          ...
          <a href='../customersignup.php'
            class='btn btn-customer m-1 border-0 text-white rounded-0 ms-3 d-none d-sm-block'>Customer</a>

          <a href="#" class="ms-3 mt-2 d-none d-sm-block" data-bs-toggle="dropdown">
            <img class="rounded-circle" src="<?php echo "images/" . $rows['u_img'] ?>" width="35" height="35">
          </a>
          ...
          echo " <a href='../customersignup.php' class='btn btn-customer border-0 text-white rounded-0 ms-2  d-none d-sm-block'>Customer</a>
                 <a href='dealersignup.php' class='btn btn-dealer border-0 text-white rounded-0 ms-2  d-none d-sm-block'>Dealer</a>";
        }
        ...
        <ul class="dd1 dropdown-menu dropdown-menu-end rounded-0">
          ...
          <hr>
<?php
          $queryorders = "SELECT * FROM order_manager WHERE dealer_id = $id";
    $runorders = mysqli_query($conn, $queryorders);
    $roworders = mysqli_fetch_array($runorders);

  
        ?>

          
          <li><a class="dropdown-item orders p-2" href="orders.php?id=<?php echo $roworders['m_id']?>"><i class="fa fa-shopping-basket ms-2 me-3"></i>
              Orders</a></li>
              <?php
