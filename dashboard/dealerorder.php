                        ...
                        if (mysqli_num_rows($runn)) {
                          ...
                          while ($rows = mysqli_fetch_array($runn)) {
                            ...
                            <tr>
                              ...
                              <td>
                               <a class="btn btn-primary px-4 btn-sm" href="orderedit.php?id=<?php echo $rows['m_id']?>"> Approved </a> 
<br>
                               <a class="btn btn-danger px-4 btn-sm w-100 mt-1" href="orderreject.php?id=<?php echo $rows['m_id']?>"> Reject </a> 
