...
<body>
  <main>
    ...
    <header>
      ...
      <br><br>
      <section>
        <h1 class="text-center fw-bold" style="color: rgb(73, 57, 113);" 7>Dealer List</h1>
        <div class="container mt-5">
          <a class="btn btncolor" data-bs-theme="dark" href="dealerdetail.php">ADD DEALER DETAIL</a>
              ...
              if (mysqli_num_rows($run)) {
                while ($row = mysqli_fetch_array($run)) {
                  ...
                  <tr>
                    ...
                    <td class="col-2"><img src="<?php echo "images/" . $row['u_img'] ?>" alt="" width="50" height="50"></td>
                    <td class="col-1">
                      <?php echo $row['u_name'] ?>
                    </td>
                    <td class="col-2">
                    ...
                    <td>
                      <a class="btn btn-primary px-4" href="dealeredit.php?id=<?php echo $row['u_id'] ?>"> Edit </a> |
                      <a class="btn btn-danger" href="dealerdelete.php?id=<?php echo $row['u_id'] ?>">Delete</a>
