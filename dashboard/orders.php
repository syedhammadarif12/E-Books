          ...
          <table class="table mt-5 text-center align-middle">
            ...
            <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-0"><?php echo $row['address']?></td>
                            <td class="col-0"><?php echo $row['contact']?></td>
                            <td class="col-2"><?php echo $row['order_date']?></td>
                        
                            <td class="col-0"><?php echo $row['b_name']?></td>
                            <td class="col-0"><?php echo $row['p_name']?></td>

                            <td class="col-0"><?php echo $row['quantity']?></td>
                            <td class="col-0"><?php echo $row['price']?></td>
                            <td class="col-0"><?php echo $row['status']?></td>
                            <td>
                               <a class="btn btn-primary px-4 btn-sm" href="orderedit.php?id=<?php echo $row['m_id']?>"> Approved </a> 
<br>
                               <a class="btn btn-danger px-4 btn-sm w-100 mt-1" href="orderreject.php?id=<?php echo $row['m_id']?>"> Reject </a> 
