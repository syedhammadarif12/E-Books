...
<!-- header -->
    <header>
        <div class="nav-wrapper">
          ...
          <br><br>
          <section>
          <h1 class="text-center fw-bold" style="color: rgb(73, 57, 113);"7>Customer List</h1>
        <div class="container mt-5">
            <a class="btn btncolor" data-bs-theme="dark" href="custname.php">ADD CUSTOMER DETAIL</a>
                ...
                <table class="table mt-5 text-center align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-1"><img src="<?php echo "images/" . $row['c_img'] ?>" alt="" width="50" height="50"></td>
                            <td class="col-1"><?php echo $row['c_name']?></td>
                            <td class="col-2"><?php echo $row['c_email']?></td>
                            <td class="col-1"><?php echo $row['c_contact']?></td>
                            <td class="col-1"><?php echo $row['c_password']?></td>
                            <td class="col-1"><?php echo $row['c_address']?></td>
                            
                            <td>
                               <a class="btn btn-primary px-4" href="cutedit.php?id=<?php echo $row['c_id']?>"> Edit  </a> | 
                            <a class="btn btn-danger" href="custdelete.php?id=<?php echo $row['c_id']?>">Delete</a> 
                 </td>
                        </tr>                                 
                        <?php
                                }
