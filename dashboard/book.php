...
<body>
  <main>
    ...
    <header>
      ...
      <br><br>
      <section>
        <h1 class="text-center fw-bold" style="color: rgb(73, 57, 113);">Books Details</h1>
        <div class="container mt-5">
          <a class="btn btncolor" data-bs-theme="dark" href="bookdetail.php">ADD BOOKS DETAILS </a>
          ...
          <table class="table mt-5 text-center align-middle">
            ...
            <tbody>
              <?php
              $sql = "SELECT book_category.*, book_detail.* FROM book_category INNER JOIN book_detail on book_category.category_id = book_detail.b_category;";
              ...
              if (mysqli_num_rows($execute)) {
                while ($row = mysqli_fetch_array($execute)) {
                  ...
                  <tr>
                    ...
                    <td><img src="<?php echo "images/" . $row['thumbnail_img'] ?>" alt="" width="50" height="80"></td>
                    <td><a class="btn btn-primary w-75" href="bookdetail_edit.php?id=<?php echo $row['b_id'] ?>">Edit</a>
                      <a class="btn btn-danger w-75 mt-2"
            href="bookdetail_delete.php?id=<?php echo $row['b_id'] ?>">Delete</a>
                      <a class="btn btn-success w-75 mt-2" href="generatepdf.php?id=<?php echo $row['b_id'] ?>">PDF</a>
                    </td>
                  </tr>
                  <?php
                }
