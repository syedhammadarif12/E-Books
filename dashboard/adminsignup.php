...
if (isset($_POST['submit'])) {
    ...
    $imgtmp = $_FILES['aimage']['tmp_name'];
    move_uploaded_file($imgtmp, "img/" . $imgname);

    $query = "INSERT INTO admins (a_name , a_email , a_password ,  a_img) VALUES('$name' , '$email' , '$pass','$imgname')";
                    ...
                    <form method="POST" enctype='multipart/form-data'>
                        ...
                        <label class="filebutton" style="text-align:center;">
                            <span class="btn">Select Image
                                <input class="form-control image" type="file" name="aimage" required>
                            </span>
                        </label>
                        <p>
