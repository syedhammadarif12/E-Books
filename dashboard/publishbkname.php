<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $query = "INSERT INTO publishing_category (p_name, p_price) VALUES ('$name ','$price')";
...
<head>
    ...
    <title>Create Publishing Category</title>
...
<!-- header -->
    <header>
        ...
        <h1 class="fw-bold text-center" style="color: rgb(73, 57, 113);">Add Publishing Category</h1>    
        <br><br>
        <form class="col-6 m-auto" method="POST">
            <input class="form-control shadow" type="text" name="cname" placeholder="Enter Publisher name..." autocomplete="off" required>
            <br>
           
            <input class="form-control shadow" type="text" name="pname" placeholder="Enter Price..." autocomplete="off" required>
            <br>
