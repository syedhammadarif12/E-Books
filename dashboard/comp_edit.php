<?php
 ...
 $query = "SELECT * FROM competition_list WHERE comp_id = $id"; 
 ...
 $query2 = "UPDATE `competition_list` SET cc_name ='$name' WHERE comp_id =  $id";
...
<!-- header -->
    <header>
        <div class="nav-wrapper">
          ...
          <h1 class="fw-bold text-center" style="color: rgb(73, 57, 113);"> Edit Competition Name</h1>    
          <br>
          <form class="col-6 m-auto" method="POST" enctype="multipart/form-data">
            <input class="form-control shadow" type="text" name="ccname" value="<?php echo $row ['comp_name']?>" autocomplete="off">
