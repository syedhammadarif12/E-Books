...
<!-- header -->
    <header>
        <div class="nav-wrapper">
          ...
          <br><br>
          <section>
          <h1 class="text-center fw-bold" style="color: rgb(73, 57, 113);"7>Competition List</h1>
        <div class="container mt-5">
            <a class="btn btncolor" data-bs-theme="dark" href="comp_name.php">ADD COMPETITION NAME</a>
            <!-- Data display In table -->
                <table class="table mt-5 text-center align-middle">
                    ...
                    <tbody>
                        <?php
                            $query = "SELECT * FROM competition_list";
                        ...
                        ?>   
                        <tr>
                            <td class="col-1"><?php echo $row['comp_id']?></td>
                            <td class="col-1"><?php echo $row['comp_name']?></td>
                            <td class="col-2"><?php echo $row['comp_description']?></td>
                            <td class="col-1"><?php echo $row['comp_prize_amount']?></td>
                            <td class="col-2"><?php echo $row['comp_start_date']?></td>
                            <td class="col-2"><?php echo $row['comp_end_date']?></td>
                            
                            <td>
                               <a class="btn btn-primary px-4" href="comp_edit.php?id=<?php echo $row['comp_id']?>"> Edit  </a> | 
                            <a class="btn btn-danger" href="compdelete.php?id=<?php echo $row['comp_id']?>">Delete</a> 
                 </td>
                        </tr>                                 
                        <?php
                                }
