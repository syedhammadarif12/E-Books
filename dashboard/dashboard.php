...
<body>
  <main>
    ...
    <header>
      ...
      <br><br>
      <section>
        <h1 class=" text-center fw-bold" style="color: rgb(73, 57, 113);">Book Categories</h1>
        <div class="container mt-5">
          <a class="btn btncolor" data-bs-theme="dark" href="category.php">ADD CATEGORY</a>
              ...
              if (mysqli_num_rows($run)) {
                while ($row = mysqli_fetch_array($run)) {
                  ...
                  <tr>
                    ...
                    <td>
                      <!-- <a class="btn btn-primary px-4" href="category_edit.php?id=<?php echo $row['category_id '] ?>"> Edit </a> |  -->
                      <a class="btn btn-danger" href="delete_category.php?id=<?php echo $row['category_id'] ?>">Delete</a>
                    </td>
                  </tr>
                  <?php
                }
