<?php
 ...
 $query = "SELECT * FROM publishing_category WHERE p_id = $id"; 
 ...
 $query2 = "UPDATE `publishing_category` SET p_name ='$name', p_price = '$price' WHERE p_id =  $id";
...
<head>
    ...
    <title>Publishing Name Edit</title>
...
<!-- header -->
    <header>
        <div class="nav-wrapper">
          ...
          <h1 class="fw-bold text-center" style="color: rgb(73, 57, 113);"> Edit Publishing Category</h1>    
          <br>
          <form class="col-6 m-auto" method="POST" enctype="multipart/form-data">
            <input class="form-control shadow" type="text" name="pname" value="<?php echo $row ['p_name']?>" autocomplete="off">
                
            <br>

            <input class="form-control shadow" type="text" name="pprice" value="<?php echo $row ['p_price']?>" autocomplete="off">
