<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query = "INSERT INTO book_category(category_name) VALUES ('$name')";
...
<!-- header -->
    <header>
        ...
        <h1 class="fw-bold text-center" style="color: rgb(73, 57, 113);">Create Book Category</h1>    
        <br><br>
        <form class="col-6 m-auto" method="POST">
            <input class="form-control shadow" type="text" name="cname" placeholder="Enter Category name..." autocomplete="off" required>
            <br>
           
            <input class=" btn btncolor" type="submit" name="submit" value="Create" data-bs-theme="dark">
        </form>
      </div>
		</div>
