    ...
    <header>
      ...
      <section>
        ...
        <div class="container mt-5">
          <a class="btn btncolor" data-bs-theme="dark" href="dealerorder.php">DEALER ORDERS DETAIL</a>
          ...
          <table class="table mt-5 text-center align-middle">
            ...
            <tbody>
                        ...
                        <?php
                        $query = "SELECT order_manager.* , customer.* FROM order_manager , customer WHERE customer.c_id = order_manager.customer_id";
...
<!-- <tbody>
<?php
                        $query = "SELECT order_manager.*, order_details.* , book_detail.*, publishing_category.* FROM order_manager INNER JOIN order_details ON order_details.o_id = order_manager.m_id INNER JOIN book_detail on order_details.book_id = book_detail.b_id INNER JOIN publishing_category on publishing_category.p_id = order_details.p_category   WHERE order_manager.customer_id > 0";
                        ...
                        <tr>
                            ...
                            <td>
                               <a class="btn btn-primary px-4" href="orderedit.php?id=<?php echo $row['m_id'] ?>"> Approved </a> |

                               <a class="btn btn-danger px-4" href="orderreject.php?id=<?php echo $row['m_id'] ?>"> Reject </a> 
