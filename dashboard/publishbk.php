...
<head>
    ...
    <title>Publishing Category</title>
...
<!-- header -->
    <header>
        <div class="nav-wrapper">
          ...
          <br><br>
          <section>
          <h1 class="text-center fw-bold" style="color: rgb(73, 57, 113);">Publishing Category</h1>
        <div class="container mt-5">
            <a class="btn btncolor" data-bs-theme="dark" href="publishbkname.php">ADD PUBLISHING CATEGORY</a>
            <!-- Data display In table -->
                <table class="table mt-5 text-center align-middle">
                    ...
                    <tbody>
                        <?php
                            $query = "SELECT * FROM publishing_category";
                        ...
                        <tr>
                            ...
                            <td>
                               <a class="btn btn-primary px-4" href="publishedit.php?id=<?php echo $row['p_id']?>"> Edit </a> | 
                            <a class="btn btn-danger" href="publishdelete.php?id=<?php echo $row['p_id']?>">Delete</a></td>
                        </tr>                                 
                        <?php
                                }
                            }
